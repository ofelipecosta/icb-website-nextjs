        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-red)" }} />
                <div>
              ...
              <div
                ...
                style={{ backgroundColor: "#fff", border: "1px solid rgba(0,0,0,0.07)", borderRadius: "var(--radius-card)" }}
              >
                <Clock className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: "var(--color-red)" }} />
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wider mb-1" style={{ color: "var(--color-ink)" }}>Horário</p>
                  <p className="text-sm leading-relaxed" style={{ color: "var(--color-anchor)" }}>
                    Ter a dom<br />
                    08h às 20h<br />
                    <span style={{ color: "var(--color-anchor)", opacity: 0.5 }}>Seg. fechado</span>
                  </p>
                </div>
              </div>
            </div>
